...
def main():
    ...
    with open(os.path.join(home_directory, 'extracted_ocr\\Lib_Co_Horsham_1810.html'), 'r') as f:
        contents = f.read()
    ...
    with open(os.path.join(home_directory, 'replication\\Lib_Co_Horsham_1810.csv'), 'wb+') as outfile:
